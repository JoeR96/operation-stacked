 ...
 *
 * The version of the OpenAPI document: 0.319
 * 
 *
 ...
 * 
 * @export
 * @interface DeleteSessionExerciseRequest
 */
export interface DeleteSessionExerciseRequest {
    /**
     * 
     * @type {string}
     * @memberof DeleteSessionExerciseRequest
     */
    'Id'?: string;
}
/**
...
export const SessionApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        /**
         * 
         * @param {DeleteSessionExerciseRequest} [deleteSessionExerciseRequest] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        apiSessionDeleteExerciseDelete: async (deleteSessionExerciseRequest?: DeleteSessionExerciseRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/session/delete-exercise`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(deleteSessionExerciseRequest, localVarRequestOptions, configuration)
...
export const SessionApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async apiSessionDeleteExerciseDelete(deleteSessionExerciseRequest?: DeleteSessionExerciseRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.apiSessionDeleteExerciseDelete(deleteSessionExerciseRequest, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['SessionApi.apiSessionDeleteExerciseDelete']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * 
...
export const SessionApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        apiSessionDeleteExerciseDelete(deleteSessionExerciseRequest?: DeleteSessionExerciseRequest, options?: any): AxiosPromise<void> {
            return localVarFp.apiSessionDeleteExerciseDelete(deleteSessionExerciseRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {DeleteSetRequest} [deleteSetRequest] 
...
export class SessionApi extends BaseAPI {
     ...
     * @memberof SessionApi
     */
    public apiSessionDeleteExerciseDelete(deleteSessionExerciseRequest?: DeleteSessionExerciseRequest, options?: RawAxiosRequestConfig) {
        return SessionApiFp(this.configuration).apiSessionDeleteExerciseDelete(deleteSessionExerciseRequest, options).then((request) => request(this.axios, this.basePath));
    }
